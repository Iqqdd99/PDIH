...
<div style="text-align: justify">
En primer tenemos este ejemplo que hemos usado para familiarizarnos con el modo de vídeo VGA 256, lo encontramos en la web http://www.brackeen.com/vga/source/bc31/pixel.c.html. Su cometido es dibujar una serie de puntos de color y posición aleatoria por toda la pantalla.
</div>
